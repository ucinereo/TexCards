...
export class FlashcardService {
  ...
  public deleteFlashcardSet(request: DeleteFlashcardSetRequest) {
    return this.httpClient.put<any>(FlashcardService.REST_API_SERVER + "flashcard/delete_flashcard_set", request);
  }
